...
<html data-wf-page="5fdd32ed8ffad5218e064176" data-wf-site="5fcd3a94a5d588c061ec8d56">
<head>
  <meta charset="utf-8">
  <title>users</title>
    ...
    <div class="projectbodydiv">
      ...
      <div class="div-block-3">
        <div class="div-block-4">
          <h1 class="mainheadings">Users</h1>
          <p>You can view all approved or pending users and also add new users to this application</p>
          <div class="buttonsdiv">
            <a data-w-id="a14e2f75-ed4f-3e85-a309-ba5406e0b2bb" href="#" class="primarybutton-2 users w-button">+ Add new users</a>
            <a href="#" class="primarybutton-2 secondary w-button">View Users</a>
          </div>
          <div class="w-form">
            <form id="email-form-2" name="email-form-2" data-name="Email Form 2" class="addlocationformblock foradmin">
              <h1 class="mainheadings">Add new user</h1>
              <p class="paragraph-8">Tell us more about this user.</p><label for="name" class="inputlabel">Username</label><input type="text" class="inputbox w-input" maxlength="256" name="name" data-name="Name" placeholder="Enter name" id="name"><label for="name" class="inputlabel">User role</label><input type="text" class="inputbox w-input" maxlength="256" name="name-2" data-name="Name 2" placeholder="Fetch address of this place" id="name-2"><input type="submit" value="Submit" data-wait="Please wait..." data-w-id="5ba0c16b-9a0c-84c0-b4f3-2f7dd3f5fa4d" class="loginbutton-2 w-button">
            </form>
